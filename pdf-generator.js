...
function generatePDF(po) {
    ...
    // Underline each line of name
    for (var i = 0; i < nameLines.length; i++) {
        var lineY = yPosition + (i * 5) + 0.5;
        doc.line(supplierValueX, lineY, rightMargin, lineY);
    }
    ...
    // Underline EVERY line of address (fixes multi-line underline bug)
